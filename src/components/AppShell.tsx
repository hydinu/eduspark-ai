        ...
        <div className="p-4 border-t border-sidebar-border">
          ...
          <div className="flex items-center gap-3 px-2 py-2">
            <div className={cn(
              ...
              guest ? "bg-muted text-muted-foreground" : "bg-gradient-primary text-primary-foreground"
            )}>
              {avatar}
            </div>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="lg:hidden flex items-center justify-between px-4 py-3 border-b bg-card">
          <Link to="/" className="flex items-center gap-2">
            ...
            <span className="font-bold">EduSpark</span>
          </Link>
          <div className="flex items-center gap-2">
            {guest ? (
              <Link to="/auth">
                <Button size="sm" variant="outline" className="text-xs h-8" id="mobile-signin-btn">
              ...
              <div className="flex items-center gap-2">
                ...
                <Button variant="ghost" size="icon" onClick={handleSignOut} id="mobile-signout-btn">
                  <LogOut className="h-4 w-4" />
                </Button>
              </div>
            )}
        ...
        {/* Guest top-bar notice on mobile */}
        {guest && (
          <div className="lg:hidden flex items-center justify-between px-4 py-2 bg-primary-soft border-b border-primary/20 text-xs">
            <span className="text-primary font-medium flex items-center gap-1.5">
              <UserCircle2 className="h-3.5 w-3.5" />
              Guest mode — progress not saved
            </span>
            <Link to="/auth" className="text-primary font-semibold underline">Sign In</Link>
          </div>
        )}
