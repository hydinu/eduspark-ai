...
function Dashboard() {
  ...
  return (
    <div className="p-3 sm:p-6 lg:p-10 max-w-7xl mx-auto">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-5 mb-6 sm:mb-8">
        {/* Quiz score card */}
        <button
        ...
        >
          <Card className="p-4 sm:p-6 hover:shadow-soft hover:border-primary/30 transition-all cursor-pointer group-hover:scale-[1.01]">
            ...
            <p className="text-xs text-muted-foreground mt-2">
              ...
              <span className="text-primary ml-2 font-medium group-hover:underline">
                View history →
              </span>
            </p>
          </Card>
              ...
              <div className="flex-1 bg-muted rounded-full h-1.5 overflow-hidden">
                <div
                  className={cn(
                    ...
                    (stats?.avgInterviewScore ?? 0) >= 80
                      ? "bg-emerald-500"
                      : (stats?.avgInterviewScore ?? 0) >= 50
                        ? "bg-amber-500"
                        : "bg-red-400",
                  )}
      ...
      <Card className="p-4 sm:p-6">
        ...
        {!stats?.recentAttempts || stats.recentAttempts.length === 0 ? (
          <div className="py-12 text-center text-muted-foreground">
            ...
            <Link to="/quizzes">
              <Button className="mt-4">Generate a quiz</Button>
            </Link>
          </div>
        ) : (
              ...
              return (
                ...
                >
                  ...
                  <div className="text-right">
                    ...
                    <div
                      className={`text-xs font-medium ${pct >= 70 ? "text-emerald-500" : pct >= 50 ? "text-amber-500" : "text-red-500"}`}
                    >
                      {pct}%
                    </div>
                  </div>
...
function ActionCard({
  ...
  return (
    <Link to={to as any}>
      <Card
        className={cn(
          "p-5 hover:shadow-soft transition-all group cursor-pointer h-full",
      ...
      >
        <div
          className={cn(
            ...
            gradient ? "bg-white/20" : "bg-primary-soft text-primary",
          )}
        >
